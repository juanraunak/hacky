...
import MarkWelcomedReducer from "./mark_welcomed_reducer";
...
import AuthResultRow from "./auth_result_table";
...
const tablesSchema = __schema({
  authResult: __table({
    name: 'auth_result',
    indexes: [
      { accessor: 'identity', name: 'auth_result_identity_idx_btree', algorithm: 'btree', columns: [
        'identity',
      ] },
    ],
    constraints: [
      { name: 'auth_result_identity_key', constraint: 'unique', columns: ['identity'] },
    ],
  }, AuthResultRow),
  boss: __table({
    name: 'boss',
  ...
  studyApple: __table({
    name: 'study_apple',
    indexes: [
      { accessor: 'id', name: 'study_apple_id_idx_btree', algorithm: 'btree', columns: [
        'id',
      ] },
      { accessor: 'room_code', name: 'study_apple_room_code_idx_btree', algorithm: 'btree', columns: [
        'roomCode',
      ] },
    ],
    constraints: [
      { name: 'study_apple_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, StudyAppleRow),
  worldEvent: __table({
    name: 'world_event',
...
const reducersSchema = __reducers(
  ...
  __reducerSchema("mark_welcomed", MarkWelcomedReducer),
  ...
  __reducerSchema("spawn_wave", SpawnWaveReducer),
...
type __SchemaWithTableAccessorAliases = Omit<typeof tablesSchema.schemaType, "tables"> & {
  tables: typeof tablesSchema.schemaType.tables & {
    /** @deprecated Use `authResult` instead. This alias will be removed in the next major version. */
    readonly "auth_result": Omit<typeof tablesSchema.schemaType.tables["authResult"], "accessorName"> & { readonly accessorName: "auth_result" };
...
export type DbView = __DbViewBase & {
  /** @deprecated Use `authResult` instead. This alias will be removed in the next major version. */
  readonly "auth_result": __DbViewBase["authResult"];
  /** @deprecated Use `heldItem` instead. This alias will be removed in the next major version. */
...
export type Tables = __TablesBase & {
  /** @deprecated Use `authResult` instead. This alias will be removed in the next major version. */
  readonly "auth_result": __TablesBase["authResult"];
  /** @deprecated Use `heldItem` instead. This alias will be removed in the next major version. */
